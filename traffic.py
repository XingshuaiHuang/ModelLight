...
traffic_category = {
    ...
    # "test": { # meta-test task2 (datasets are missing*)
    ...
    # },
    # "city": city_train_phase,  # manually change (3_1: meta-test task3 homo)
    "city": city_test_phase,  # manually change (3_2: meta-test task3 hete)
}
